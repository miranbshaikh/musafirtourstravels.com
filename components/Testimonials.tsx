    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
            <div className="text-center">
                <p className="text-lg font-medium text-gray-600 font-pj">1000+ people have said how good are the services of Musafir Tours and Travels</p>
                        ...
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“I Had Booked A Force Urbania On Rent With Them, The Driver Was Very Professional In His Approach & We Had A Wonderful Time On Our Trip.”</p>
                                </blockquote>
                            </div>
                            ...
                            <div className="flex items-center mt-8">
                                ...
                                <div className="ml-4">
                                    <p className="text-base font-bold text-gray-900 font-pj">Jazera Baba</p>
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Congnizant Pune</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“I Had Booked A Family Tours & Travel Package To Alibag With Them & Our Family Members Enjoyed Alot.”</p>
                                </blockquote>
                            </div>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“I Had Booked A 17 Seater Force Urbania With Them, For Our Corporate Picnic, Our Team Had A Great Bonding, Spending Good Time With Each Other.”</p>
                                </blockquote>
                            </div>
